                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(24),
                          border: Border.all(color: const Color(0xFF00FF9D).withOpacity(0.20)),
                          boxShadow: [BoxShadow(color: const Color(0xFF00FF9D).withOpacity(0.15), blurRadius: 30)],
                        ),
                        child: const Icon(Icons.diamond_outlined, color: Color(0xFF00FF9D), size: 36),
                      ),
      ...
      children: [
        TextField(
          ...
          decoration: InputDecoration(
            ...
            counterText: '',
            prefixIcon: const Icon(Icons.key_outlined, color: Color(0xFF94A3B8), size: 20),
            filled: true,
            fillColor: Colors.white.withOpacity(0.03),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
        ...
        TextButton(
          ...
          child: const Text('Use a different email', style: TextStyle(color: Color(0xFF94A3B8), fontSize: 14)),
        ),
      ],
    );
  }
